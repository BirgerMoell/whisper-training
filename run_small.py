...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-small-sv-augmented",  # change to a repo name of your choice
    ...
    save_steps=1000,  # set to < max_steps
    eval_steps=1000,  # set to < max_steps
    logging_steps=1000,  # set to < max_steps
...
kwargs = {
    ...
    "language": "sv",
    "model_name": "whisper-small-sv-augmented",  # a 'pretty' name for our model
