...
tokenizer = WhisperTokenizer.from_pretrained("openai/whisper-medium", language="Swedish", task="transcribe")
...
processor = WhisperProcessor.from_pretrained("openai/whisper-medium", language="Swedish", task="transcribe")
...
training_args = Seq2SeqTrainingArguments(
    output_dir="./whisper-medium-sv-bm",  # change to a repo name of your choice
...
kwargs = {
    ...
    "language": "sv",
    "model_name": "WhisperMediumSwedishBirgerMoell",  # a 'pretty' name for our model
...
# pipe = pipeline(model="birgermoell/whisper-medium-sv-bm")  # change to "your-username/the-name-you-picked"
